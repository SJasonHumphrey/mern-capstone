...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            const user = await axios.post('/register',userObject)
        ...
        <div className="full-page-wrapper d-flex flex-column align-items-center justify-content-center mono-font">
            <Form onSubmit={handleSubmit} className="drop-shadow bg-main  col-6 d-flex flex-column py-5">
                ...
                <Form.Group className="p-4">
                    ...
                    <Form.Control onChange={(e)=>setUsername(e.target.value)} type='text' placeholder='enter username'></Form.Control>
                </Form.Group>
                <Form.Group className="p-4">
                    <Form.Label>Password</Form.Label>
                    <Form.Control onChange={(e)=>setPassword(e.target.value)}type='text' placeholder='enter password'></Form.Control>
                </Form.Group>
